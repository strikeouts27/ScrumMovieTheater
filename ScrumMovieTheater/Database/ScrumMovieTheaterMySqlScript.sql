...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ 'c267dea0-6052-11f1-8708-9c6b00683b4b:1-148';
...
CREATE TABLE `showrooms` (
  ...
  CONSTRAINT `FK_Showroom` FOREIGN KEY (`FK_Movie`) REFERENCES `movies` (`idMovie`)
...
CREATE TABLE `theaters` (
  ...
  CONSTRAINT `FK_Showroom_Theater_1` FOREIGN KEY (`FK_Showroom1`) REFERENCES `showrooms` (`idShowroom`),
  CONSTRAINT `FK_Showroom_Theater_2` FOREIGN KEY (`FK_Showroom2`) REFERENCES `showrooms` (`idShowroom`),
  CONSTRAINT `FK_Showroom_Theater_3` FOREIGN KEY (`FK_Showroom3`) REFERENCES `showrooms` (`idShowroom`),
  CONSTRAINT `FK_Showroom_Theater_4` FOREIGN KEY (`FK_Showroom4`) REFERENCES `showrooms` (`idShowroom`),
  CONSTRAINT `FK_Showroom_Theater_5` FOREIGN KEY (`FK_Showroom5`) REFERENCES `showrooms` (`idShowroom`)
...
INSERT INTO `theaters` VALUES (1,'Dallas','8687 N Central Expy #3000,','Dallas Theater',1,2,3,4,5),(2,'Houston','11801 S Sam Houston Pkwy E','Houston Theater',6,7,8,9,10),(3,'San Antonio','849 E Commerce St Suite 800','San Antonio',11,12,13,14,15),(4,'Austin','2901 S Capital of Texas Hwy','Austin',16,17,18,19,20),(5,'Fort Worth','5015 Trailhead Bnd Wy','Fort Worth',21,22,23,24,25);
...
-- Dump completed on 2026-06-12 17:49:06
