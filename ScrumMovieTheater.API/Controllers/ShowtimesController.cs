...
namespace ScrumMovieTheater.API.Controllers
{
    ...
    public class ShowtimesController : ControllerBase
    {
        ...
        {
            var showtimeToUpdate = _showtimeContext.Showtimes.FirstOrDefault(s => s.ShowtimeId.Equals(id));
        ...
        {
            var showtimeToDelete = _showtimeContext.Showtimes.FirstOrDefault(s => s.ShowtimeId.Equals(id));
